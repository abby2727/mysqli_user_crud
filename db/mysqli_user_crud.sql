...
(1, 'Rirejo', 'zuzonem@mailinator.com', 'password'),
(2, 'Hytideci', 'bibeximojy@mailinator.com', 'password'),
(5, 'Zabukyme', 'xawab@mailinator.com', 'secret'),
(6, 'Pimenowy', 'vavifone@mailinator.com', 'secret');
COMMIT;
